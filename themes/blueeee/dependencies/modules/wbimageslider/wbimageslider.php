    ...
    protected function installSamples()
    {
        ...
        for ($i = 1; $i <= 3; ++$i) {
            ...
            foreach ($languages as $language) {
                ...
                $slide->description[$language['id_lang']] = '<h1>New Hot Look</h1><h1>Sexy & Hotest Lingerie</h1> <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p> <h5><a href="#" class="btn btn-primary">shop now -></a></h5>';
