...
<div id="productCommentsBlock">
    {* <h1 class="h1 products-section-title text-uppercase rtitle">{l s='Reviews' mod='productcomments'}</h1> *}
    <div id="product_comments_block_tab">
        ...
        <div id="">
                        ...
                        <div class="comment clearfix" itemprop="review" itemscope itemtype="https://schema.org/Review">
                            <div class="comment_author" >
                                ...
                                <div class="comment_author_infos" >
                                    ...
                                    <h3>{dateFormat date=$comment.date_add|escape:'html':'UTF-8' full=0}</h3><div class="arr">|</div>
            ...
            {else}
                ...
                {else}
                    <p class="align_center rrnews">{l s='No customer reviews for the moment.' mod='productcomments'}</p>
                {/if}
            {/if}
        </div>
</div>
                    ...
                    <div class="new_comment_form_content">
                        ...
                        <div id="new_comment_form_footer">
                            ...
                            <p class="fr">
                                ...
                                {l s='or' mod='productcomments'}&nbsp;<a href="#" onclick="$.fancybox.close();" class="btn btn-primary">{l s='Cancel' mod='productcomments'}</a>
                            </p>
                            <div class="clearfix"></div>
                        </div>
                    </div>
