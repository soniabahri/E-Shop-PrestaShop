      ...
      <div class="col-sm-6 col-xl-5 col-lg-6 col-md-6 col-xs-12 sticky">
        ...
        <div class="col-sm-6 col-xl-7 col-lg-6 col-md-6 col-xs-12 propage">
          ...
          {/block}
            ...
            <a href="#rate" id="ratep"><i class="fa fa-comments-o"></i>{l s='read review' d='Shop.Theme.Global'}</a>
          </div>
            <hr>
    ...
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-accessories clearfix spepro">
          <h1 class="heading text-xs-left"><span><span>{l s='Related Product' d='Shop.Theme.Global'}</span><hr></span></h1>
