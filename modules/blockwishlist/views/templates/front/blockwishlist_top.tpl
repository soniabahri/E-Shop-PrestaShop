...
<li class="wishl wi-he d-inline-block">
	...
	<div class="wimg"><svg width="24px" height="24px"> <use xlink:href="#hwish"></use></svg>{l s='wishlist' mod='blockwishlist'}</div>{* <span class="cart-wishlist-number">{$count_product}</span> *}
	</a>
</li>
