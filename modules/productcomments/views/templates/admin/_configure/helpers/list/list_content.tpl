            ...
            {foreach $fields_display AS $key => $params}
                ...
                {/if}
                    ...
                    {elseif isset($params.type) && $params.type == 'percent'}
                        {$tr.$key} {l s='%' mod='productcomments'}
                        ...
                        {if isset(Module::getInstanceByName('reviewsreply')->active)}
                            {if Module::getInstanceByName('reviewsreply')->active == true && $identifier == 'id_product_comment'}
                                <div class="pull-right">
                                    <a onclick="$(this).closest('tr').next('tr').show();" class="btn btn-small btn-default"><i class="icon-pencil"></i> {l s='Reply' mod='productcomments'}</a>
                                </div>
                            {/if}
                        {/if}
                    {/if}
                            ...
                            <form method="post">
                                ...
                                <div class="col-lg-12">
                                    <button class="btn btn-large btn-success">
                                        <i class="icon-save"></i> {if isset($reply.0)}{l s='Save reply' mod='productcomments'}{else}{l s='Add reply' mod='productcomments'}{/if}
                                    </button>
                                </div>
                            </form>
                        </td>
    ...
    <tr>
        <td class="list-empty" colspan="{count($fields_display)+1}">
            <div class="list-empty-msg">
                ...
                {l s='No records found' mod='productcomments'}
            </div>
        </td>
    </tr>
{/if}
