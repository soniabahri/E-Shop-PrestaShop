...
class ProductComments extends Module
{
    ...
    {
        return array(
            'PRODUCT_COMMENTS_GDPRCMS' => Tools::getValue(
                'PRODUCT_COMMENTS_GDPRCMS',
                Configuration::get('PRODUCT_COMMENTS_GDPRCMS')
            ),
            'PRODUCT_COMMENTS_GDPR' => Tools::getValue(
                'PRODUCT_COMMENTS_GDPR',
                Configuration::get('PRODUCT_COMMENTS_GDPR')
            ),
            'PRODUCT_COMMENTS_MODERATE' => Tools::getValue(
                'PRODUCT_COMMENTS_MODERATE',
                Configuration::get('PRODUCT_COMMENTS_MODERATE')
            ),
            'PRODUCT_COMMENTS_ALLOW_GUESTS' => Tools::getValue(
                'PRODUCT_COMMENTS_ALLOW_GUESTS',
                Configuration::get('PRODUCT_COMMENTS_ALLOW_GUESTS')
            ),
            'PRODUCT_COMMENTS_MINIMAL_TIME' => Tools::getValue(
                'PRODUCT_COMMENTS_MINIMAL_TIME',
    ...
    public function hookDisplayProductListReviews($params)
    {
        ...
        if (!$this->isCached('module:productcomments/views/templates/front/productcomments_reviews.tpl', $this->getCacheId($id_product))) {
        ...
        return $this->fetch('module:productcomments/views/templates/front/productcomments_reviews.tpl', $this->getCacheId($id_product));
    }
